...
const examSchema = z.object({
  ...
  num_items: z.number().min(1, 'Must have at least 1 item').max(200, 'Maximum 200 items'),
  choices_per_item: z.number().min(2, 'Minimum 2 choices').max(6, 'Maximum 6 choices'),
  student_id_length: z.number().min(4, 'Minimum 4 digits').max(12, 'Maximum 12 digits'),
  ...
  return (
    <div className="page-container max-w-2xl">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">Fill in the exam details to get started</p>
      </div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {errors.num_items && <p className="text-sm text-destructive">{errors.num_items}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              {errors.choices_per_item && <p className="text-sm text-destructive">{errors.choices_per_item}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleChange('student_id_length', e.target.value)}
                className={errors.student_id_length ? 'border-destructive' : ''}
              />
              <p className="text-xs text-muted-foreground">Default: 9 digits</p>
              {errors.student_id_length && <p className="text-sm text-destructive">{errors.student_id_length}</p>}
            </div>
